import {
  ...
  GetByIdMedicalHistoryRequest,
} from '@/layer/lib/requests/GetMedicalHistoryRequest';
import {
  CreateMedicalHistoryRequest,
  UpdateMedicalHistoryRequest,
} from '@/layer/lib/requests/CreateMedicalHistoryRequest';
...
describe('that request classes inherit from ApiGatewayRequest', () => {
  it('shows that requests should be an implementation of ApiGwRequest', () => {
    ...
    expect(GetMedicalHistoryRequest.prototype).toHaveProperty('validate');
